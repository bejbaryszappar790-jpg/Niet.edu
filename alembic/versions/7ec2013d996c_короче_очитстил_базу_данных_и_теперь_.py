...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_Student_student_email"), "Student", ["student_email"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_Teacher_teacher_id"), "Teacher", ["teacher_id"], unique=False
    )
    op.create_table(
        "Enrollment",
    ...
    op.create_index(
        op.f("ix_Enrollment_enrollment_id"),
        "Enrollment",
        ["enrollment_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_Workshop_workshop_id"), "Workshop", ["workshop_id"], unique=False
    )
    op.create_table(
        "Video",
